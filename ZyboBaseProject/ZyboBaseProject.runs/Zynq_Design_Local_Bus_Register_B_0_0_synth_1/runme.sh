...
HD_PWD='G:/Xilinx/Projects/Desktop/AXI_4_Lite_Slave/AXI_4_Lite_Slave.runs/Zynq_Design_Local_Bus_Register_B_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Zynq_Design_Local_Bus_Register_B_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Zynq_Design_Local_Bus_Register_B_0_0.tcl
