...
ISEStep( "vivado",
         "-log Zynq_Design_AXI_UART_Control_Ada_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Zynq_Design_AXI_UART_Control_Ada_0_0.tcl" );
